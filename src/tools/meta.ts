        ...
        text: JSON.stringify(
          {
            sources: [
              ...
              },
              {
                ...
                type: "internal",
                description:
                  "Pillar-to-provision mapping for DORA (Regulation (EU) 2022/2554) and all 10 implementing standards (8 RTS + 2 ITS) covering 324 provisions across 5 pillars. Provision text fetched from eu-regulations-mcp at runtime.",
                update_frequency: "Per release",
              },
              {
